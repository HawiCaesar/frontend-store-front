        ...
        <div className='flex-auto px-4 lg:px-10 py-10 pt-0'>
          <form>
            <h6 className='text-blueGray-400 text-sm mt-3 mb-6 font-bold'>
              {t('settings.forms.userInfo.title')}
            </h6>
            <div className='flex flex-wrap'>
              <div className='w-full lg:w-6/12 px-4'>
                <div className='relative w-full mb-3'>
                  ...
                  >
                    {t('settings.forms.userInfo.inputs.username')}
                  </label>
                  <input
                    type='text'
              ...
              <div className='w-full lg:w-6/12 px-4'>
                <div className='relative w-full mb-3'>
                  <label
                    ...
                    htmlFor='grid-password'
                  >
                    {t('settings.forms.userInfo.inputs.email')}
                  </label>
                  <input
                    type='email'
                    className='border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150'
              ...
              <div className='w-full lg:w-6/12 px-4'>
                <div className='relative w-full mb-3'>
                  <label
                    ...
                    htmlFor='grid-password'
                  >
                    {t('settings.forms.userInfo.inputs.firstName')}
                  </label>
                  <input
                    type='text'
                    className='border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150'
              ...
              <div className='w-full lg:w-6/12 px-4'>
                <div className='relative w-full mb-3'>
                  <label
                    ...
                    htmlFor='grid-password'
                  >
                    {t('settings.forms.userInfo.inputs.lastName')}
                  </label>
                  <input
                    type='text'
                    className='border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150'
